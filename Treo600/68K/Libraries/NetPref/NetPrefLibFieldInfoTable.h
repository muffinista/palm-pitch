 ...
 * 
 *  Description:
 *	  This header file contains record field information for
 *	  NetPref settings.  See usage info in the comments below
 *
 *	Note:
 *
 *	History:
 *	  11-Jan-2002	vmk	  Created by Vitaly Kruglikov; 
 *
 ****************************************************************/
