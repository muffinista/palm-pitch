 ...
 * \file HsExtTraps.h
 *
 * Definitions of selectors used for the 68K trap based
...
// NOTE: These trap selectors were never implemented and never used, therefore they are safe to be reassigned
#define hsNeverUsedBeforeAvailableForUse1 0xAE
#define hsNeverUsedBeforeAvailableForUse2 0xAF
