 ...
 * \file HsPhoneTraps.h
 *
 * Traps of all functions exported by the Phone Library
 *
 *
 * \license
 *
...
#define     GSMReservedFirst                            (150+sysLibTrapCustom)
...
#define     GSMReserved23                               (23+GSMReservedFirst)
#define     GSMReserved24                               (24+GSMReservedFirst)
#define     GSMReserved25                               (25+GSMReservedFirst)
#define     GSMReserved26                               (26+GSMReservedFirst)
#define     GSMReserved27                               (27+GSMReservedFirst)
#define     GSMReserved28                               (28+GSMReservedFirst)
#define     GSMReserved29                               (29+GSMReservedFirst)
#define     GSMReservedLast                             (29+GSMReservedFirst)
...
#define     PhnLibTrapGetNAMInUse                       (243+sysLibTrapCustom)    // CDMA Only
#define     PhnLibTrapCommitIOTAParams                  (244+sysLibTrapCustom)    // CDMA Only
...
#define		PhnLibTrapGetSysPrefMode					(275+sysLibTrapCustom)	  // CDMA Only (Verizon)
#define		PhnLibTrapSetSysPrefMode					(276+sysLibTrapCustom)	  // CDMA Only (Verizon)
#define		PhnLibTrapGetLifeTimer	                    (277+sysLibTrapCustom) 
#define		PhnLibTrapGetVoicePrivacyMode				(278+sysLibTrapCustom)	  // CDMA Only (Verizon)
#define		PhnLibTrapSetVoicePrivacyMode				(279+sysLibTrapCustom)	  // CDMA Only (Verizon)
#define     PhnLibTrapGetMMSServerInfo                  (280+sysLibTrapCustom)	  // CDMA Only (Verizon)
#define     PhnLibTrapGetSMSSegmentInfo                 (281+sysLibTrapCustom)	  // CDMA Only (Verizon)
#define		PhnLibTrapLast					            (282+sysLibTrapCustom)    
