...
#define netMasterErrCDMACarrierNetworkBusy		(netMasterErrClass + 0x3D)	// "network busy" event was received
...
#define netMasterErrOneXServiceNotEnabled		(netMasterErrClass + 0x4F)	// modem doesn't support
																			// requested service
