...
enum httpError_ {
	...
	httpErrorDNSInval 		= -101,
	httpErrorDNSNoServer	= -102,
	httpErrorDNSTimedout	= -103,
	httpErrorDNSNotFound	= -104,
	httpErrorTCPOpen		= -105,
	httpErrorTCPConnect		= -106,
	httpErrorTCPRead		= -107,
	httpErrorTCPWrite		= -108,
	httpErrorSSLConnect		= -109,
	httpErrorSSLHandShake	= -110,
	httpErrorSSLRead		= -111,
	httpErrorSSLWrite		= -112,
	httpErrorReqTimedout	= -113,
	httpErrorRspTimedout	= -114,
	httpErrorCacheNone		= -115,
	httpErrorCacheExpire	= -116,
	httpErrorAuthUnknown	= -117,
	httpErrorAuthNoHeader	= -118,
	httpErrorAuthFormat		= -119,
	httpErrorRedirectFormat	= -120,
	httpErrorRedirectCanceled	= -121,
	httpErrorReqHeaderSizeOver	= -122,	/* method GET */
	httpErrorReqBodySizeOver	= -123, /* method POST */
	httpErrorRspHeaderSizeOver	= -124,
	httpErrorReqTooManyContinue = -125,
	httpErrorTLSIntolerant	= -126
};
